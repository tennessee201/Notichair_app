...
public class App extends Application {
    ...
    private static volatile com.example.notichair_Real.App instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return com.example.notichair_Real.App.getGlobalApplicationContext();
                }
            };
        }
    }

    public static com.example.notichair_Real.App getGlobalApplicationContext() {
        if(instance == null) {
